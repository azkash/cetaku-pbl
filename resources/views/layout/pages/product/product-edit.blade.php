              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="product_name" name="product_name" value="X-Banner Standard" required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="5">X-Banner standard dengan berbagai pilihan ukuran dan bahan. Cocok untuk promosi, event, dan pameran.</textarea>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div id="size-container">
                    <div class="row mb-3 size-row">
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="sizes[0][name]" value="60x160 cm" placeholder="Nama ukuran (ex: 60x160cm)">
                      </div>
                      <div class="col-md-3">
                        <input type="number" class="form-control" name="sizes[0][price]" value="120000" placeholder="Harga">
                      </div>
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="sizes[0][description]" value="Ukuran standar" placeholder="Deskripsi (opsional)">
                      </div>
                      <div class="col-md-1">
                    ...
                    <div class="row mb-3 size-row">
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="sizes[1][name]" value="80x180 cm" placeholder="Nama ukuran (ex: 60x160cm)">
                      </div>
                      <div class="col-md-3">
                        <input type="number" class="form-control" name="sizes[1][price]" value="150000" placeholder="Harga">
                      </div>
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="sizes[1][description]" value="Ukuran besar" placeholder="Deskripsi (opsional)">
                      </div>
                      <div class="col-md-1">
                        <button type="button" class="btn btn-danger btn-sm remove-size">
                          <i class="fas fa-times"></i>
                ...
                <div class="card-body">
                  ...
                  <div id="material-container">
                    <div class="row mb-3 material-row">
                      <div class="col-md-4">
                        <input type="text" class="form-control material-name" name="materials[0][name]" value="Albatros" placeholder="Nama bahan">
                      </div>
                      <div class="col-md-3">
                        <input type="number" class="form-control" name="materials[0][price]" value="0" placeholder="Harga tambahan">
                      </div>
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="materials[0][description]" value="Bahan standard" placeholder="Deskripsi (opsional)">
                      </div>
                      <div class="col-md-1">
                    ...
                    <div class="row mb-3 material-row">
                      <div class="col-md-4">
                        <input type="text" class="form-control material-name" name="materials[1][name]" value="Flexi Korea" placeholder="Nama bahan">
                      </div>
                      <div class="col-md-3">
                        <input type="number" class="form-control" name="materials[1][price]" value="20000" placeholder="Harga tambahan">
                      </div>
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="materials[1][description]" value="Kualitas premium" placeholder="Deskripsi (opsional)">
                      </div>
                      <div class="col-md-1">
                        <button type="button" class="btn btn-danger btn-sm remove-material">
                          <i class="fas fa-times"></i>
                ...
                <div class="card-body">
                  ...
                  <div id="finishing-container">
                    <div class="row mb-3 finishing-row">
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="finishing[0][name]" value="Laminating Glossy" placeholder="Nama finishing">
                      </div>
                      <div class="col-md-3">
                        <input type="number" class="form-control" name="finishing[0][price]" value="15000" placeholder="Harga tambahan">
                      </div>
                      <div class="col-md-4">
                        <input type="text" class="form-control" name="finishing[0][description]" value="Mengkilap" placeholder="Deskripsi (opsional)">
                      </div>
                      <div class="col-md-1">
                        ...
                        <table class="table table-bordered" id="materials-availability-table">
                          ...
                          <tbody>
                            <tr>
                              <td>Albatros</td>
                              <td>
                                <select class="form-control" name="material_availability[0][status]">
                              ...
                              <td>
                                <input type="text" class="form-control" name="material_availability[0][note]" placeholder="Catatan (opsional)">
                              </td>
                            </tr>
                            <tr>
                              <td>Flexi Korea</td>
                              <td>
                                <select class="form-control" name="material_availability[1][status]">
                                  <option value="1" selected>Tersedia</option>
                                  <option value="2">Terbatas</option>
                                  <option value="0">Tidak Tersedia</option>
                                </select>
                              ...
                              <td>
                                <input type="text" class="form-control" name="material_availability[1][note]" placeholder="Catatan (opsional)">
                              </td>
                            </tr>
                          </tbody>
                        </table>
            ...
            <div class="tab-pane fade" id="images" role="tabpanel">
              <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="additional_images">Pilih file</label>
                          </div>
                        </div>
                        <small class="form-text text-muted">Format: JPG, PNG, maksimal 2MB per file</small>
                      </div>
                      
                      <div class="row mt-4" id="additional-images-preview">
                        <div class="col-md-4 mb-3">
                          <div class="img-preview-container">
                            <img src="/api/placeholder/150/150" class="img-thumbnail" alt="Preview">
                            <button type="button" class="btn btn-sm btn-danger remove-img-btn">
                              <i class="fas fa-times"></i>
                            </button>
                          </div>
                        </div>
                ...
                <div class="col-md-6">
                  <div class="card card-outline card-secondary">
                    <div class="card-header">
                      <h3 class="card-title">Template Design</h3>
                    </div>
                    <div class="card-body">
                      <div class="form-group">
                        <label for="template_file">Upload Template (.ai, .psd, .pdf)</label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="template_file" name="template_file">
                            <label class="custom-file-label" for="template_file">Template-X-Banner.ai</label>
                          </div>
                        </div>
                      ...
                      <div class="form-group mt-4">
                        ...
                        <textarea class="form-control" id="template_description" name="template_description" rows="3">Template X-Banner 60x160cm dengan area aman 58x158cm, resolusi 150dpi, CMYK</textarea>
                      </div>
                    </div>
                  </div>
                </div>
